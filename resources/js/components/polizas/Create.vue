        ...
        <form @submit.prevent="crearPoliza">
            <div class="card">
                <div class="card-header">
                    <p class="d-inline align-bottom">CREAR POLIZA</p>
                </div>
                <div class="p-3">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" mb-1">
                                        <select name='tipo_riesgo_id' class="form-control form-control-sm select2"
                                            value="tipo_riesgo_id" v-model="poliza.tipo_riesgo_id">
                                            <option v-for="tipo_riesgo in tipo_riesgos" :key="tipo_riesgo.id"
                                                v-bind:value="tipo_riesgo.id">{{tipo_riesgo.nombre}}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" mb-1">
                                        <select name='compania_id' class="form-control form-control-sm select2" value="compania_id"
                                            id="compania_id" v-model="poliza.compania_id" @change='cargarCodigos_Productor(poliza.compania_id)'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class=" mb-1">
                                        <select name='codigo_productor_id' class="form-control form-control-sm select2"
                                            value="codigo_productor_id" v-model="poliza.codigo_productor_id">
                                            <option v-for="codigo_productor in codigo_productores" :key="codigo_productor.id"
                                                v-bind:value="codigo_productor.id">{{codigo_productor.productores.apellido}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="text" class="form-control form-control-sm" id="numero" name="numero"
                                            v-model="poliza.numero" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tipo_vigencia_id" class=" control-label">Vigencia</label>
                                    <div class="mb-1">
                                        <select name='tipo_vigencia_id' class="form-control form-control-sm " value="tipo_vigencia_id"
                                            v-model="poliza.tipo_vigencia_id" @change='sumarMes(poliza.tipo_vigencia_id)'>
                                            <option v-for="tipo_vigencia in tipo_vigencias" :key="tipo_vigencia.id"
                                                v-bind:value="tipo_vigencia.id">{{tipo_vigencia.vigencia}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="vigencia_desde"
                                            name="vigencia_desde" v-model="poliza.vigencia_desde">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="vigencia_hasta" class=" control-label">Hasta:</label>
                                    <div class="">
                                        <input type="date" class="form-control form-control-sm" id="vigencia_hasta"
                                            name="vigencia_hasta" v-model="poliza.vigencia_hasta">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_solicitud"
                                            name="fecha_solicitud" v-model="poliza.fecha_solicitud">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fecha_emision" class=" control-label">Emision:</label>
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_emision" name="fecha_emision"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_recepcion"
                                            name="fecha_recepcion" v-model="poliza.fecha_recepcion">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fecha_entrega_original" class=" control-label">Entrega de Original:</label>
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_entrega_original"
                                            name="fecha_entrega_original" v-model="poliza.fecha_entrega_original">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fecha_entrega_email" class=" control-label">Envio x Email:</label>
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_entrega_email"
                                            name="fecha_entrega_email" v-model="poliza.fecha_entrega_email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="fecha_entrega_correo" class=" control-label">Envio x Correo:</label>
                                    <div class="mb-1">
                                        <input type="date" class="form-control form-control-sm" id="fecha_entrega_correo"
                                            name="fecha_entrega_correo" v-model="poliza.fecha_entrega_correo">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            <input type="text" class="form-control form-control-sm" id="premio" name="premio"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            <input type="text" class="form-control form-control-sm" id="prima" name="prima"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            <input type="text" class="form-control form-control-sm" id="comision" value="0"
                                                name="comision" v-model="poliza.comision">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-1">
                                            <input type="text" class="form-control form-control-sm" id="descuento" name="descuento"
                        ...
                        <div class="card p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class=" mb-1">
                                            <input type="text" class=" form-control form-control-sm" id="cantidad_cuotas"
                                                name="cantidad_cuotas" v-model="poliza.cantidad_cuotas">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <textarea class="form-control form-control-sm mb-1" rows="3" id="detalle_medio_pago"
                                            name='detalle_medio_pago' v-model="poliza.detalle_medio_pago"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
