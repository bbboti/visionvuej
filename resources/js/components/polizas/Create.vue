                                ...
                                <p class="d-inline align-bottom">CREAR POLIZA</p>
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class=" mb-1">
                                                                <select name='compania_id' class="form-control form-control-sm select2" value="compania_id" id="compania_id" v-model="poliza.compania_id" @change='cargarCodigos_Productor(poliza.compania_id)'>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <div class=" mb-1">
                                                                <select name='codigo_productor_id' class="form-control form-control-sm select2" value="codigo_productor_id" v-model="poliza.codigo_productor_id">
                                        ...
                                        <div class="col-md-3">
                                                <div class="form-group">
                                                        ...
                                                        <div class="mb-1">
                                                                <input type="text" class="form-control form-control-sm" id="numero" name="numero" v-model="poliza.numero" placeholder="">
                                                        </div>
                                                </div>
                                                <div class="form-group">
